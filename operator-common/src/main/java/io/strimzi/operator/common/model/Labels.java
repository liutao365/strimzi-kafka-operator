...
public class Labels {
    ...
    private static Labels additionalLabels(Map<String, String> additionalLabels) {
        ...
        Map<String, String> filteredLabels = additionalLabels
                ...
                .stream()
                .filter(entryset ->
                        !entryset.getKey().startsWith(Labels.KUBERNETES_DOMAIN) || entryset.getKey().equals(KUBERNETES_PART_OF_LABEL) || entryset.getKey().equals(KUBERNETES_DEPLOY_BY_LABEL) || entryset.getKey().equals(KUBERNETES_COMPONENT_LABEL) || entryset.getKey().equals(KUBERNETES_NAME_LABEL) || entryset.getKey().equals(KUBERNETES_MANAGED_BY_LABEL))
